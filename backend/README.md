...
The backend exposes a `/transcribe_audio` endpoint that accepts raw audio data and returns a transcript generated by OpenAI Whisper. Responses and suggestions are biased toward Indonesian by default.
